...
Alternate way to do generator: combine two calls to flow_images_from_dataframe
```{r}
...
train_target_generator <- flow_images_from_dataframe(dataframe = train.path.df,
                                             ...
                                             generator = image_data_generator(
                                              preprocessing_function = function(x) x-1),
                                             target_size = c(200,200),
...
system.time(str(train_generator()))

system.time(str(train_generator2())) # 2 - 3 times faster, same data
